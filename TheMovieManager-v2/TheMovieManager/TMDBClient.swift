...
class TMDBClient : NSObject {
    ...
    func taskForGETMethod(_ method: String, parameters: [String:AnyObject], completionHandlerForGET: (result: AnyObject?, error: NSError?) -> Void) -> URLSessionDataTask {
    ...
    func taskForPOSTMethod(_ method: String, parameters: [String:AnyObject], jsonBody: String, completionHandlerForPOST: (result: AnyObject?, error: NSError?) -> Void) -> URLSessionDataTask {
